        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->role === 'admin' ? route('admin-dashboard') : (Auth::user()->role === 'dokter' ? route('dokter-dashboard') : route('pasiens.landingpage')) }}" class="flex items-center space-x-3 group">
