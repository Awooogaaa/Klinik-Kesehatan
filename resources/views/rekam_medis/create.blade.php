            ...
            @if($kunjungans->isEmpty())
                <div class="bg-white overflow-hidden shadow-xl rounded-2xl border border-gray-100">
                    <div class="p-12 text-center">
                        ...
                        <p class="text-gray-500 mb-6">Tidak ada antrian pasien dengan status "Disetujui". Silakan atur jadwal kunjungan terlebih dahulu.</p>
                    ...
                    <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-rose-500 to-pink-600">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-rose-100 text-sm">Catat hasil pemeriksaan dan resep obat</p>
                            </div>
                        </div>
                    </div>

                    <div class="p-8">
                        <form action="{{ route('rekam_medis.store') }}" method="POST" x-data="resepForm()" class="space-y-8">
                            @csrf
                            ...
                            <div>
                                <div class="flex items-center justify-between mb-6">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h3 class="font-semibold text-lg text-gray-800">3. Resep Obat</h3>
                                            <p class="text-sm text-gray-500">Tambahkan obat yang diresepkan (opsional)</p>
                                        </div>
                                    </div>
