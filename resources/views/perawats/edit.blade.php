                    ...
                    <form method="POST" action="{{ route('perawats.update', $perawat) }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                                ...
                                <label class="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200 hover:border-pink-300 hover:bg-pink-50 cursor-pointer transition-all group {{ !$perawat->dokter_id ? 'border-pink-500 bg-pink-50' : '' }}">
                                    <input type="radio" name="dokter_id" value="" 
                                        {{ old('dokter_id', $perawat->dokter_id) === null ? 'checked' : '' }}
                                ...
                                @foreach($dokters as $dokter)
                                    <label class="flex items-center p-4 bg-gray-50 rounded-xl border border-gray-200 hover:border-pink-300 hover:bg-pink-50 cursor-pointer transition-all group {{ $perawat->dokter_id == $dokter->id ? 'border-pink-500 bg-pink-50' : '' }}">
                                        <input type="radio" name="dokter_id" value="{{ $dokter->id }}" 
                                            {{ old('dokter_id', $perawat->dokter_id) == $dokter->id ? 'checked' : '' }}
                                            class="w-5 h-5 border-gray-300 text-pink-600 focus:ring-pink-500">
                                        <div class="ml-3">
